...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        ...
        <form class="form-horizontal form-wizard form" action="/terms" method="POST" method="post">
            @csrf
                                ...
                                <div class="row mg-t-25">
                                    <div class="col-lg-10">
                                        ...
                                        <input type="number" id="contactnumber" name="contactnumber"
                                            placeholder="Contact Number" class="form-control" autofocus required>
                                        ...
                                        <input type="text" id="nric" name="nric" placeholder="NRIC" class="form-control"
                                            autofocus required>
                                        ...
                                        <input type="text" id="additionalrequirements" name="additionalrequirements"
                                            placeholder="Additional Requirements" class="form-control" autofocus>
