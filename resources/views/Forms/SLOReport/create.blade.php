...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        ...
        <form class="form-horizontal form-wizard form" action="{{ route('slo-report.store') }}" method="POST"
                            ...
                            <div class="col-lg-10">
                                <div class="row mg-t-25">
                                    <div class="col-lg-10">
                                        ...
                                        <textarea rows="5" class="form-control" name="report_details"
                                            placeholder="Report Details" required></textarea>

                                        <div class="mg-t-25">
                                            <h6 class="form-label">Action by SLO (if any)<span style="color:red"></span>
                                            </h6>
                                        </div>

                                        <textarea rows="5" class="form-control" name="slo_action"
                            ...
                            <div class="col-lg-10">
                                <div class="row mg-t-25">
                                    <div class="col-lg-10">
                                        ...
                                        <textarea rows="5" class="form-control" name="followup"
                                            placeholder="Next Follow Up" required></textarea>
                                    </div><!-- col-3 -->
                                </div><!-- row -->
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                <div class="row mg-t-25">
                                    <div class="col-lg-10">
                                        <label class="ckbox">
                                            <input type="checkbox" required><span>I hereby declare that the information
