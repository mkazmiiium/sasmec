                ...
                <div class="row ">
                    ...
                    <div class="col-lg-10">
                        <div class="row mg-t-25">
                            <div class="col-lg-10">
                                <div class="mg-t-25">
                                    <h6 class="form-label">Type of Complaint<span style="color:red">*</span></h6>
                                </div>

                                <select class="form-control select2" name="complaint_type" required>
                                    <option label="Choose one" disable selected></option>
                                    <option value="Improper Attire/Dress Code">Improper Attire/Dress Code</option>
                                    <option value="Inappropritate Socializing">Inappropritate Socializing</option>
