...
<html>
  ...
  <body>
    ...
    <div style="float: left" class="top right">
      <p>Date:<br>Time:</p></div>

    <div style="float: right">
      <p>IIUM-IIUMMC-SHAR-F011<br>VER: 01<br>REV: 01<br>EFFECTIVE DATE: 12 MAY 2021</p>
    </div>
    ...
    <div style="position: relative; text-align: center">
      ...
      <div class="col-span-6 sm:col-span-10">
        <div class="col-sm-9">
          ...
          <input type="text" id="date" value="{{ $clinic->created_at }}" name="date" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" style="width:250px">
        </div>
      </div><br>
