                    ...
                    <div class="grid grid-cols-10 gap-6">
                      <div class="col-span-6 sm:col-span-10">
                        ...
                        <div class="form-group col-md-12">
                            <textarea id="issue" name="issue" cols="300" rows="5" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"></textarea>
                  ...
                  <div x-show.transition.in="step === 2">
                    <div class="grid grid-cols-10 gap-6">
                      <div class="col-span-6 sm:col-span-10">
                        ...
                        <div class="form-group col-md-12">
                            <textarea id="comment" name="comment" cols="300" rows="1" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"></textarea>
                      ...
                      <div class="col-span-6 sm:col-span-10">
                        ...
                        <div class="form-group col-md-12">
                            <textarea id="correctiveaction" name="correctiveaction" cols="300" rows="1" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"></textarea>
                      ...
                      <div class="col-span-6 sm:col-span-10">
                        ...
                        <div class="form-group col-md-12">
                            <textarea id="followup" name="followup" cols="300" rows="1" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"></textarea>
                ...
                <div class="max-w-3xl mx-auto px-4">
                  <div class="flex justify-between">
                    ...
                    <div class="w-1/2 text-right">
                      <button type="button" x-show="step < 2" @click="step++" class="rounded-sm px-3 py-1 bg-blue-700 hover:bg-blue-500 text-white focus:shadow-outline focus:outline-none" >Next</button>
                      <button type="draft" class="rounded-sm px-3 py-1 bg-blue-700 hover:bg-blue-500 text-white focus:shadow-outline focus:outline-none" >Save to Draft</button>
                      <button type="submit" @click="step = 'complete'" x-show="step === 2" class="rounded-sm px-3 py-1 bg-blue-700 hover:bg-blue-500 text-white focus:shadow-outline focus:outline-none">Submit</button>
                    </div>
                  </div>
                </div>
              </div>
