                        ...
                        <div class="col-lg-10">
                            <div class="row mg-t-25">
                                <div class="col-lg-10">
                                    ...
                                    <input type="date" name="referreddate" id="referreddate" class="form-control" style="width:170px" >

                                    <div class="mg-t-25">
                                        <label for="attendeddate" class="form-label">Attended Date <span style="color:red">*</label>
                                    </div>
    
                                    <input type="date" name="attendeddate" id="attendeddate" class="form-control" style="width:170px" >
    
                                    <div class="mg-t-25">
                                    <label for="reason" class="form-label">Reason for Referral</label>
                                    </div>
    
                                    <textarea class="form-control" id="reason" rows="5" name="reason" required style="width:700px;"></textarea>
                    ...
                    <div class="col-lg-10">
                        <div class="row mg-t-25">
                            <div class="col-lg-10">
                                ...
                                <textarea class="form-control" id="background" rows="5" name="background" required style="width:700px;"></textarea>

                                <div class="mg-t-25">
                                <label for="currentcondiiton" class="form-label">Current Condition</label>
                                </div>

                                <textarea class="form-control" id="currentcondiiton" rows="5" name="currentcondiiton" required style="width:700px;"></textarea>

                                <div class="mg-t-25">
                                <label for="problem" class="form-label">Problem</label>
                                </div>
    
                                <textarea class="form-control" id="problem" rows="5" name="problem" required style="width:700px;"></textarea>

                                <div class="mg-t-25">
                                <label for="intervention" class="form-label">Intervention</label>
                                </div>
    
                                <textarea class="form-control" id="intervention" rows="5" name="intervention" required style="width:700px;"></textarea>

                                <div class="mg-t-25">
                                <label for="casestatus" class="form-label">Case Status/Outcome</label>
                                </div>
    
                                <textarea class="form-control" id="casestatus" rows="5" name="casestatus" required style="width:700px;"></textarea>

                                <div class="mg-t-25">
                                <label for="followup" class="form-label">Next Follow Up (if any):</label>
                                </div>
    
                                <textarea class="form-control" id="followup" rows="5" name="followup" required style="width:700px;"></textarea>
