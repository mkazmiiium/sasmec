...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        ...
        <form class="form-horizontal form-wizard form" action="{{ route('complaint.store') }}" method="POST"
                                ...
                                <div class="row mg-t-25">
                                    <div class="col-lg-10">
                                        ...
                                        <textarea rows="5" class="form-control" name="details"
                                            placeholder="Complaint Details" required></textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                <div class="row mg-t-25">
                                    <div class="col-lg-10">
                                        <label class="ckbox">
                                            <input type="checkbox"><span>I hereby declare that the information given in
