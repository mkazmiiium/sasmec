...
<body>
  ...
  <div style="float: left">
    <p>Date:{{ strftime("%d %b %Y",strtotime($clinic->created_at)) }}<br>Time:{{ strftime("%T",strtotime($clinic->created_at)) }}</p>
  </div>
  ...
  <div style="position: relative; text-align: center">
    ...
    <h4>SULTAN AHMAD SHAH MEDICAL CENTRE @IIUM<br>DEPARTMENT OF SHARIAH COMPLIANCE<br>SHARIAH CLINIC FORM</h4>
  </div>
