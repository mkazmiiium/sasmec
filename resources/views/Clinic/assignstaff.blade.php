    ...
    <div class="flex flex-col w-full p-5 mx-auto card">
                ...
                <div class="flex flex-col w-full mx-auto">
                    <div class="mb-2 md:mb-1 md:flex items-center">
                        ...
                        <div class="flex-1 text-lg">
                            <form action="{{ url('clinic/assign-staff/store/'.$clinic->id) }}" method="POST">
                            @csrf
            ...
            <div class="flex justify-between mt-3">
                <div class="flex flex-col ">
                    <div class="text-gray-800 block font-bold text-lg uppercase underline underline-offset-4 tracking-wide">Comments/Corrective Action/Follow Up</div>
                    
                    <div class="pt-4 mb-2 md:mb-1 md:flex items-center">
                        <label class="pr-2 text-gray-800 block font-bold text-lg uppercase tracking-wide">Comments</label>
                        <span class="mr-4 inline-block hidden md:block">:</span>
