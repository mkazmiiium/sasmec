...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        ...
        <form class="form-horizontal form-wizard form" action="{{ url('/clinic/comment/store/'.$clinic->id) }}"
            method="POST" method="post" onsubmit="return submitUserForm();">
            @csrf
                            ...
                            <div class="col-lg-10">
                                <div class="row mg-t-25">
                                    <div class="col-lg-10">
                                        ...
                                        <div class="mg-t-50">
                                            <label for="doc_expertise"
                                                class="form-label">Suggestions/Recommendations/Comments</label>
                                            <textarea id="comment" name="comment" cols="500" rows="1"
                                                class="form-control" minlength="5" required></textarea>
                                        ...
                                        <div class="mg-t-25">
                                            ...
                                            <textarea id="correctiveaction" name="correctiveaction" cols="300" rows="1"
                                                class="form-control" minlength="5" required></textarea>
                                        ...
                                        <div class="mg-t-25">
                                            ...
                                            <textarea id="followup" name="followup" cols="300" rows="1"
                                                class="form-control" minlength="5" required></textarea>
