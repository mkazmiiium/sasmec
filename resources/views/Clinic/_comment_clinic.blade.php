...
<script src="https://unpkg.com/@themesberg/flowbite@1.3.0/dist/datepicker.bundle.js"></script>
  ...
  <div class="w-full h-full justify-center">
        <p class="text-x1 font-bold p-2">Shariah Clinic Form</p>
	...
	<div x-data="app()" class="max-w-3xl mx-auto rounded-xl" x-cloak>
        ...
        <form action="{{ url('/clinic/comment/store/'.$clinic->id) }}" method="POST">
          {{-- @if(session('message'))
                ...
                <div class="max-w-3xl mx-auto px-4">
                  <div class="flex justify-between">
                    ...
                    <div class="w-1/2 text-right">
                      ...
                      <button type="submit" @click="step = 'complete'" x-show="step === 1" class="rounded-sm px-3 py-1 bg-blue-700 hover:bg-blue-500 text-white focus:shadow-outline focus:outline-none">Submit</button>
                    </div>
                  </div>
                </div>
              </div>
