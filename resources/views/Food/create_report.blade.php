              ...
              <div class="col-lg-10">
                <div class="row mg-t-25">
                  <div class="col-lg-10">
                    ...
                    <div class="mg-t-25">
                      <label for="programname" class="form-label">Name of Program <span
                          style="color:red">*</span></label>
                    </div>


                    <input type="text" id="programname" name="programname" placeholder="Name of Program"
                      class="form-control" autofocus minlength="5" required>

                    <div class="mg-t-25">
                      <label for="PremiseName" class="form-label">Premise Name  <span
                        style="color:red">*</span></label>
                    </div>
                    <input type="text" id="PremiseName" name="PremiseName" placeholder="Premise Name"
                      class="form-control" autofocus minlength="5" required>



                    <div class="mg-t-25">
                      <label for="location" class="form-label">Premise Location  <span
                        style="color:red">*</span></label>
                    </div>
                    <input type="text" id="location" name="location" placeholder="Premise Location" class="form-control"
                      autofocus minlength="5" required>
                    ...
                    <div class="mg-t-25">
                      <div class="mg-t-25">
                        <div class="checkbox">
                          <label>
                            <input type="checkbox" id="declaration" name="declaration" required> We agree to accept any
                            inspection done by Shariah Officer of SASMEC @IIUM
                  ...
                  <table id="datatable1" class="table display responsive nowrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q6" value="no" required>
                        </td>
                  ...
                  <table id="datatable1" class="table display responsive nowrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q7" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q8" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q9" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q10" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q11" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q12" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q13" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q14" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q15" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q16" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q17" value="no" required>
                        </td>
                  ...
                  <table id="datatable1" class="table display responsive nowrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q18" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <br>
                          <div>
                            <input type="radio" id="yes" name="Q191" value="yes" required>
                          </div>
                          <div>
                            <input type="radio" id="yes" name="Q192" value="yes" required>
                          </div>
                        </td>
                        <td>
                          <br>
                          <div>
                            <input type="radio" id="no" name="Q191" value="no" required>
                          </div>
                          <div>
                            <input type="radio" id="no" name="Q192" value="no" required>
                          </div>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q20" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q21" value="no" required>
                        </td>
                      ...
                      <tr>
                        <td>
                          <label for="remarks22" class="form-label">5. Storage area<br>+ Raw foods stored separately
                            from ready-
                        ...
                        <td><br>
                          <div>
                            <input type="radio" id="yes" name="Q221" value="yes" required>
                          </div>
                          <div>
                            <input type="radio" id="yes" name="Q222" value="yes" required>
                          </div>
                          <div>
                            <input type="radio" id="yes" name="Q223" value="yes" required>
                          </div>
                          <div>
                            <input type="radio" id="yes" name="Q224" value="yes" required>
                          </div>
                        </td>
                        <td><br>
                          <div>
                            <input type="radio" id="no" name="Q221" value="no" required>
                          </div>
                          <div>
                            <input type="radio" id="no" name="Q222" value="no" required>
                          </div>
                          <div>
                            <input type="radio" id="no" name="Q223" value="no" required>
                          </div>
                          <div>
                            <input type="radio" id="no" name="Q224" value="no" required>
                          </div>
                        </td>
                      ...
                      <tr>
                        <td>
                          ...
                          <textarea placeholder="Remarks" id="remarks23" name="remarks23" class="form-control"
                            id="remarks" rows="1" style="width:400px;"></textarea>
                        </td>
                        <td>
                          <input type="radio" id="yes" name="Q23" value="yes" required>
                        </td>
                        <td>
                          <input type="radio" id="no" name="Q23" value="no" required>
                        </td>
                      ...
                      <tr>
                        <td>
                          <label for="remarks24" class="form-label">7. Chiller / Freezer<br>+ Halal and Haram items
                            stored separately (if any)</label>
                          <textarea placeholder="Remarks" id="remarks24" name="remarks24" class="form-control"
                            id="remarks" rows="1" style="width:400px;"></textarea>
                        </td>
                        <td><br>
                          <div>
                            <input type="radio" id="yes" name="Q24" value="yes" required>
                          </div>
                        </td>
                        <td><br>
                          <div>
                            <input type="radio" id="no" name="Q24" value="no" required>
                          </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q25" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q26" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q27" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q28" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q29" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q30" value="no" required>
                        </td>
                  ...
                  <table id="datatable1" class="table display responsive nowrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q31" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q32" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q33" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q34" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q35" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td><br>
                          <div>
                            <input type="radio" id="yes" name="Q36" value="yes" required>
                          </div>
                        </td>
                        <td><br>
                          <div>
                            <input type="radio" id="no" name="Q36" value="no" required>
                          </div>
                        </td>
                  ...
                  <table id="datatable1" class="table display responsive nowrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q37" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q38" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q39" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q40" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q41" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q42" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q43" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td><br>
                          <div>
                            <input type="radio" id="yes" name="Q44" value="yes" required>
                          </div>
                        </td>
                        <td><br>
                          <div>
                            <input type="radio" id="no" name="Q44" value="no" required>
                          </div>
                        </td>
                  ...
                  <table id="datatable1" class="table display responsive nowrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q45" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q46" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q47" value="no" required>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="no" name="Q48" value="no" required>
                        </td>
              ...
              <div class="row mg-t-25">
                <div class="col-lg-10">
                  ...
                  <div class="form-group col-md-12">
                    <textarea id="comment" name="comment" cols="40" rows="5" class="form-control" id="remarks" rows="4"
                      style="width:800px;"></textarea>
                  </div><br>

                  <label for="correctiveaction" class="font-semibold leading-none">Corrective Action:</label>
                  <div class="form-group col-md-12">
                    <textarea id="correctiveaction" name="correctiveaction" cols="40" rows="5" class="form-control"
                      id="remarks" rows="4" style="width:800px;"></textarea>
                  </div>
                </div><!-- col-3 -->
              </div><!-- row -->
            </div>
