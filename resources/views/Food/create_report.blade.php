...
<div class="sl-mainpanel">
  ...
  <div class="sl-pagebody">
    ...
    <form class="form-horizontal form-wizard form" action="/food/store" method="POST" method="post" onsubmit="return submitUserForm();">
      @csrf
              ...
              <div class="col-lg-10">
                <div class="row mg-t-25">
                  <div class="col-lg-10">
                    ...
                    <div class="mg-t-25">
                      <label for="programname" class="form-label">Name of Program <span style="color:red">*</span></label>
                    </div>


                    <input type="text" id="programname" name="programname" placeholder="Name of Program" class="form-control" autofocus minlength="5" required>

                    <div class="mg-t-25">
                      <label for="PremiseName" class="form-label">Premise Name <span style="color:red">*</span></label>
                    </div>
                    <input type="text" id="PremiseName" name="PremiseName" placeholder="Premise Name" class="form-control" autofocus minlength="5" required>



                    <div class="mg-t-25">
                      <label for="location" class="form-label">Premise Location <span style="color:red">*</span></label>
                    </div>
                    <input type="text" id="location" name="location" placeholder="Premise Location" class="form-control" autofocus minlength="5" required>
                ...
                <div class="table-wrapper">
                  <table id="datatable1" class="table display responsive nowrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <label for="remarks4" class="form-label">3. Certificate of halal from JAKIM<br> halal certification bodies & authorities</label>
                ...
                <div class="table-wrapper">
                  <table id="datatable1" class="table display responsive nowrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <label for="remarks5" class="form-label">1. Certificate of halal from any recognised foreign halal certification bodies and authorities</label>
