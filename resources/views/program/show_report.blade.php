			  ...
			  <table class="min-w-full divide-y divide-gray-200">
				...
				<tbody class="bg-white divide-y divide-gray-200">
				  ...
				  <tr>
					...
					<td class="px-6 py-1 whitespace-nowrap"><span class="text-sm font-medium text-gray-900">{{ $program->pic }}</span></td>
                    <td class="px-6 py-4 whitespace-nowrap"><span class="text-sm font-medium text-gray-900">{{ $program->briefing_person }}</span></td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
					  ...
					  <button class="bg-green-200 hover:bg-green-300 text-green-800 hover:text-green-900 font-bold py-1 px-2 rounded inline-flex items-center">
						  <svg style="width:24px;height:24px" viewBox="0 0 24 24">
							...
							<a href ="{{ action('App\Http\Controllers\Form\ProgramController@pdf', $program->id) }}" class="btn btn-danger" >Download PDF</a>
						</button>
					  </td>
					</tr>
