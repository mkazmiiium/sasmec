...
@section('content')
  ...
  <div class="-my-2 w-full mx-auto overflow-x-auto sm:-mx-6 lg:-mx-8">
    <div class="align-middle inline-block min-w-full sm:px-6 lg:px-8">
      ...
      <div class="px-3 text-2xl font-bold">Program Monitoring Details</div>
  ...
  <div class="max-w-full border-dashed border-4 border-gray-600 bg-white flex flex-col rounded overflow-hidden shadow-lg">
    ...
    <div class="flex flex-col w-full p-5 mx-auto card">
                ...
                <div class="flex flex-col w-full mx-auto">
                    ...
                    {{-- <div class="mb-2 md:mb-1 md:flex items-center">
                        ...
                        <button class="bg-indigo-200 hover:bg-indigo-300 text-indigo-600 hover:text-indigo-900 font-bold py-1 px-2 rounded inline-flex items-center">
                            ...
                            <a href="" class="px-2 items-center text-indigo-800 hover:text-indigo-900">Update Staff</a>
                        </button>
                        @else
                        @endif
            ...
            <div class="pt-6 flex flex-row justify-between ">
                <div class="flex flex-col w-full mx-auto">
                    <div class="text-gray-800 block font-bold text-lg tracking-wide">During Program</div>
                   
                    <div class="mb-2 md:mb-1 md:flex items-center">
                        <div class="flex-1 text-lg">{{ $program->during_prog_report }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="pt-6 flex flex-row justify-between ">
                <div class="flex flex-col w-full mx-auto">
                    <div class="text-gray-800 block font-bold text-lg tracking-wide">After Program</div>
                   
                    <div class="mb-2 md:mb-1 md:flex items-center">
                        <div class="flex-1 text-lg">{{ $program->corrective_action }}</div>
                    </div>
                </div>
            </div>
    </div>
